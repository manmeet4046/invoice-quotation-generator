...
* {
   /* outline: 1px solid red;*/
    ...
    <div>
        <h1 class="text-2xl font-bold mb-4">Create New Company</h1>
    ...
    <div class="flex flex-col gap-4 rounded-xl border border-neutral-200 dark:border-neutral-700">
       <form wire:submit.prevent="save" enctype="multipart/form-data" class="space-y-12 m-10 p-6 bg-white dark:bg-gray-800 rounded-lg shadow">
    ...
    <div class="sm:w-2/3">
        ...
        />
            ...
            <div class="flex justify-center mt-2 w-full">
                <flux:button type="submit" variant="primary" class="w-1/2">
                    Save & Next
                </flux:button>
            </div>
        </form>
